...
const TRUST = [
  "Intent-led account structure",
  "Revenue-tied optimization",
      ...
      <div className="svc-header-grid relative z-10 mx-auto grid max-w-[1240px] grid-cols-[1.08fr_0.92fr] items-center gap-[clamp(40px,5vw,72px)] px-8 py-[clamp(96px,11vw,140px)] pb-[clamp(64px,7vw,96px)]">
        <div>
          ...
          <h1 className="hero-reveal hero-reveal-1 mb-6 text-balance font-extrabold font-sans text-[clamp(34px,4.6vw,56px)] text-white leading-[1.02] tracking-[-0.03em]">
            Google Ads services that turn demand into{" "}
            <span className="text-tangerine-400">profitable growth</span>
          </h1>
          <p className="hero-reveal hero-reveal-2 mb-8 max-w-[520px] font-sans text-lg text-white/74 leading-relaxed">
            Google Ads gives you immediate access to high-intent demand. The
            difference is whether that demand turns into profit. We build and
            manage Google Ads programs designed to convert, not just generate
            clicks.
          </p>
        ...
        <ServiceGlassForm
          formName="google-ads-services-contact"
          ...
          messagePlaceholder="Tell us about your paid search goals"
