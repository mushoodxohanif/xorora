  ...
  return (
    <LightSection>
      <div className="ind-reveal max-w-[760px]">
        ...
        <p className="mt-10 font-sans text-[16px] text-fg2 leading-relaxed">
          We take a fully integrated approach, aligning negotiation, content,
          advertising, inventory, and analytics into one program built around
          your revenue and margin goals. We don&apos;t optimize listings or run
          ads in isolation. We manage the entire first-party relationship, from
          agreement terms to conversion rates, so every element compounds.
        </p>
        <div className="mt-8">
          <LetsTalkContactLink
