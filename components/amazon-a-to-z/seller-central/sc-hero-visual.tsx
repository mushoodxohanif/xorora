...
const METRICS = [
  { label: "Revenue", value: "Third-party", sub: "Seller Central" },
  { label: "ACOS / TACOS", value: "Full-funnel", sub: "Sponsored ads" },
  { label: "Organic rank", value: "Catalog", sub: "A+ Content" },
  { label: "Buy Box", value: "Eligibility", sub: "Win rate" },
] as const;

export function ScHeroVisual() {
  return (
