    ...
    <section className="relative overflow-hidden bg-navy-900 px-8 py-[clamp(56px,7vw,88px)]">
      ...
      <div className="relative mx-auto flex max-w-[1180px] flex-wrap items-center justify-between gap-8">
        <div className="max-w-[640px]">
          <h2 className="mb-3 text-balance font-extrabold font-sans text-[clamp(26px,3.4vw,40px)] text-white leading-tight tracking-tight">
            Got a project in mind? Let&apos;s bring it to life.
          </h2>
          <p className="m-0 font-sans text-[16px] text-white/68 leading-relaxed">
            Let our team draft a discovery plan and turn your goals into a
