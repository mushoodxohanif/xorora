...
const ROWS: {
  ...
  {
    label: "Senior Java availability",
...
export function JwdChoose() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How to choose"
        title="Choosing a Java web development company"
        sub="Ask any Java web development company three questions. Where do they stand on virtual threads versus reactive, and can they defend it. How do they handle the persistence session boundary. What is their sequence for a jakarta migration that keeps the system shippable throughout. Those answers separate engineers who have maintained Java systems from ones who have only started them."
      ...
      <p className="mb-10 max-w-[720px] font-sans text-[15.5px] text-fg2 leading-relaxed">
        ...
        call. Our work is strongest when you need senior Java capacity now, when
