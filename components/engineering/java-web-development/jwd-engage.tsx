...
const MODELS = [
  ...
  },
  {
    ...
    body: "Sprint-based delivery with priorities set at each sprint boundary. Best when discovery is ongoing or requirements will move. Usually the right shape for migration and decomposition work, where the third month teaches you what the first could not.",
  },
  {
    icon: Users,
    title: "Staff augmentation",
    body: "Our Java engineers working inside your team, under your process and your management. Best when you have the direction and need capacity. Engineers stay with your project rather than rotating.",
    href: ROUTES.staffAugmentation,
  },
] as const;

export function JwdEngage() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How we engage"
        title="Java development engagement models"
