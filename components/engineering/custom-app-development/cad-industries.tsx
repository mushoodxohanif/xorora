...
const INDUSTRIES: {
...
}[] = [
  {
    icon: "heart-pulse",
    name: "Healthcare",
    body: "Clinical and operational apps that fit regulated workflows, from patient portals to care coordination.",
    href: ROUTES.industry("health-tech"),
  },
  {
    icon: "handshake",
    name: "HR and Employee Management",
    body: "Workforce apps for onboarding, scheduling, and internal services that keep teams productive.",
    href: ROUTES.industries,
  },
  {
    icon: "shopping-cart",
    name: "Retail and eCommerce",
    body: "Shopping, inventory, and loyalty experiences that keep catalog and fulfillment data in sync.",
    href: ROUTES.industry("ecommerce"),
  },
  {
    icon: "layout-grid",
    name: "Computer Software",
    body: "Product apps and companion experiences that extend your platform for customers and operators.",
    href: ROUTES.industry("saas"),
  },
  {
    icon: "landmark",
    name: "Finance and Accounting",
    body: "Secure financial apps for payments, reporting, and client portals with audit-ready design.",
    href: ROUTES.industry("fintech"),
  },
  {
    icon: "megaphone",
    name: "Marketing and Recognition",
    body: "Campaign, engagement, and recognition apps that connect marketing programs to measurable outcomes.",
    href: ROUTES.industries,
  },
  {
    icon: "rocket",
    name: "Startups",
    body: "Investor-ready MVPs with clear architecture and a path from first release to production scale.",
    href: ROUTES.industry("startups"),
  },
];

export function CadIndustries() {
  return (
    <LightSection bg="var(--slate-50)">
      <SectionHead
        label="Industries"
        title="Industries"
        sub="Xorora builds custom applications for teams across sectors, enhancing business software and features in industries including:"
