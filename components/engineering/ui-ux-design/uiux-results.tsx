    ...
    <div id="work">
      <LightSection bg="var(--slate-50)">
        <div className="mb-4 flex flex-wrap items-end justify-between gap-5">
          <SectionHead
            label="Proof of work"
            title="Our most successful projects"
          />
          <Link
            href={ROUTES.ourWork}
        ...
        <p className="mb-10 max-w-[640px] font-sans text-[16px] text-fg2 leading-relaxed">
          We&apos;ve worked with industry leaders and disruptive startups
          worldwide, delivering innovative, scalable, secure solutions, from
          healthcare software to enterprise cloud platforms.
        </p>
        <div className="svc-grid3 grid grid-cols-3 gap-6">
          {RESULTS.map((c) => (
            <UiuxCaseCard key={c.href} {...c} />
          ))}
        </div>
      </LightSection>
    </div>
