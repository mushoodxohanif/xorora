...
const MODELS = [
  ...
  },
  {
    ...
    body: "Sprint-based delivery with priorities set at each sprint boundary. Best when discovery is ongoing or requirements will move. Common on app work, where the first build round the user testing changes the second.",
  },
  {
    icon: Users,
    title: "Staff augmentation",
    body: "Our Flutter engineers working inside your team, under your process and your management. Best when you have the direction and need capacity. Engineers stay with your project rather than rotating.",
    href: ROUTES.staffAugmentation,
  },
] as const;

export function FmdEngage() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How we engage"
        title="Flutter development engagement models"
        sub="All three carry the same handover terms. Source, signing credentials, store access, and documentation are yours throughout."
