...
const MODELS = [
  ...
  },
  {
    ...
    body: "Our Node.js engineers working inside your team, under your process and your management. Best when you have the direction and need capacity. Engineers stay with your project rather than rotating.",
    href: ROUTES.staffAugmentation,
  },
] as const;

export function NwdEngage() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How we engage"
        title="Node.js web development engagement models"
