...
const MODELS = [
  ...
  },
  {
    ...
    body: "Sprint-based delivery with priorities set at each sprint boundary. Best when discovery is ongoing or requirements will move. This is usually the right shape for migration work, where the third month teaches you things the first month could not.",
  },
  {
    icon: Users,
    title: "Staff augmentation",
    body: "Our .NET engineers working inside your team, under your process and your management. Best when you have the direction and need capacity. Engineers stay with your project rather than rotating.",
    href: ROUTES.staffAugmentation,
  },
] as const;

export function CdnEngage() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How we engage"
        title=".NET development engagement models"
