...
const ROWS: {
  ...
  {
    label: "Senior Python availability",
    values: ["Immediate", "Scarce and expensive", "Variable"],
  },
  {
...
export function PwdChoose() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How to choose"
        title="Choosing a Python web development company"
        sub="What separates a top Python web development company from a cheap one is where the cost lands. Cheap delivery front-loads the saving and back-loads it into maintenance, incidents, and eventual rewrites."
      ...
      <p className="mb-10 max-w-[720px] font-sans text-[15.5px] text-fg2 leading-relaxed">
        ...
        call. Our work is strongest when you need senior Python capacity now, or
