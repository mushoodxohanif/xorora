...
const MODELS = [
  {
    icon: FileText,
    title: "Fixed scope",
    body: "Defined requirements, agreed deliverables, a fixed price. Best when the problem is well understood and the boundary is clear. You know the total before work starts.",
  },
  {
    icon: CalendarClock,
    title: "Variable scope",
    body: "Sprint-based delivery with priorities set at each sprint boundary. Best when discovery is ongoing or requirements will move.",
  },
  {
    icon: Users,
    title: "Staff augmentation",
    body: "Our Python engineers working inside your team, under your process and your management. Best when you have the direction and need capacity.",
    href: ROUTES.staffAugmentation,
  },
] as const;

export function PadEngage() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How we engage"
        title="Python application development engagement models"
        sub="All three carry the same handover terms. Source, infrastructure, and documentation are yours throughout."
