...
const ROWS: {
  ...
  {
    label: "Senior Django availability",
    values: ["Immediate", "Scarce at senior level", "Wide quality spread"],
  },
  {
...
export function DdcChoose() {
  return (
    <LightSection bg="var(--surface)">
      <SectionHead
        label="How to choose"
        title="Choosing a Django development agency"
        sub="Most Django development agencies can build the first version. Fewer can tell you how they write a migration that survives a rolling deploy, where they put business logic once models get large, or how they stop the admin becoming a product. Ask those three questions of any Django development company you're evaluating."
      ...
      <p className="mb-10 max-w-[720px] font-sans text-[15.5px] text-fg2 leading-relaxed">
        ...
        call. Our work is strongest when you need senior Django capacity now,
        when an upgrade or performance engagement has a defined end, or when
        your team needs the first version built properly and then handed over.
      </p>
