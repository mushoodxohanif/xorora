...
const photoSeo = imageAltTitle({
  primary: "Plan your Django project",
  secondary: "Engineers scoping a Django platform build",
  context: "technical discovery call",
});

export function DdcMidCta() {
  return (
      ...
      <div className="mx-auto grid max-w-[1180px] items-center gap-[clamp(32px,5vw,64px)] lg:grid-cols-2">
        <div>
          ...
          <p className="mb-4 max-w-[520px] font-sans text-[16.5px] text-fg2 leading-relaxed">
            Bring us the platform you&apos;re building, or the Django
            application that got slow and nobody can say why. Discovery takes
            one to two weeks and produces an architecture proposal and a fixed
            estimate.
          </p>
        ...
        <div className="relative aspect-[5/4] overflow-hidden rounded-(--r-xl) border border-indigo-100 lg:aspect-auto lg:min-h-[340px]">
          <Image
            src={SEO_LANDING_IMAGES.django.midCta}
            alt={photoSeo.alt}
